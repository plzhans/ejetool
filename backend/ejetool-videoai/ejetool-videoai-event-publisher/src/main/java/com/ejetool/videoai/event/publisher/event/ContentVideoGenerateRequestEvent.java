...
@JsonDeserialize(builder = ContentVideoGenerateRequestEvent.JsonBuilder.class)
public class ContentVideoGenerateRequestEvent extends BaseEvent {
    ...
    @Builder
    @JsonCreator
    public ContentVideoGenerateRequestEvent(
